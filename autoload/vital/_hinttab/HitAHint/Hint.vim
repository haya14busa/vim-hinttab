...
execute join(['function! vital#_hinttab#HitAHint#Hint#import() abort', printf("return map({'create': '', '_vital_loaded': ''}, \"vital#_hinttab#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
" function() wrapper
